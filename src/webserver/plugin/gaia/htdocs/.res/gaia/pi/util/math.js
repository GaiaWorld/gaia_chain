 ...
 * @return  数字
 */
exports.round = function (nfloat, n) {
    var i = Math.pow(10, n);
 ...
 * @return  数字
 */
exports.roundInt = function (nint, n) {
    var i = Math.pow(10, n);
 ...
 *
 */
exports.randomFloat = function (v1, v2) {
 ...
 *
 */
exports.randomInt = function (v1, v2) {
 ...
 *
 */
exports.cryptoRandomInt = function () {
    if (crypto) {
 ...
 *
 */
exports.cryptoRandomInts = function (array) {
    if (crypto) {
 ...
 * @example
 */
exports.getDirection = function (vx1, vy1, vx2, vy2) {
 ...
 * @example
 */
exports.getAngle = function (vx1, vy1, vx2, vy2) {
 ...
 * @example
 */
exports.linear = function (t, p0, p1) {
    return (p1 - p0) * t + p0;
};
/**
 * @description  阶乘
...
exports.factorial = function (n) {
    var len = facCache.length;
    if (n < len) {
        return facCache[n];
    }
    var s = facCache[len - 1];
    for (var i = len; i <= n; i++) {
        s *= i;
        facCache.push(s);
    }
 ...
 * @example
 */
exports.bernstein = function (i, n) {
 ...
 * @example
 */
exports.catmullRom = function (t, p0, p1, p2, p3) {
    var v0 = (p2 - p0) * 0.5;
    var v1 = (p3 - p1) * 0.5;
    var t2 = t * t;
    var t3 = t * t2;
 ...
 */
exports.nextPowerOfTwo = function (value) {
    --value;
    value |= value >> 1;
    value |= value >> 2;
    value |= value >> 4;
...
var facCache = [0, 1, 2];
// 单个安全的随机32位整数的计算缓冲
var cryptoCache = new Uint32Array(1);
})